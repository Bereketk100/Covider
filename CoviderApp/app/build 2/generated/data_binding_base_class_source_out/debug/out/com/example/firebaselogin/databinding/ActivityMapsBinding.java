...
public final class ActivityMapsBinding implements ViewBinding {
  ...
  private ActivityMapsBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogout,
      @NonNull Button btnprof, @NonNull Button home) {
  ...
  public static ActivityMapsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMapsBinding((ConstraintLayout) rootView, btnLogout, btnprof, home);
    }
